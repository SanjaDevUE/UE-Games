...
#include "CCGamePlayTagLibrary.generated.h"

class AActor;
class ACCPlayerState;

/**
* Utility function for adding checking and removing gameplay tags
*/
UCLASS()
class UCCGamePlayTagLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	...
	UFUNCTION(BlueprintPure, Category = "RTS")
	static FGameplayTagContainer GetPlayerRelationshipTags(const ACCPlayerState* ActorPlayerState, const ACCPlayerState* OtherPlayerState);
